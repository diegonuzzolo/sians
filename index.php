...
<div class="bg-dark text-white  text-center py-5" style="border-radius: 15px; background-image: url('assets/minecraft-bg2.jpg'); background-size: cover; background-position: center;">
    <div class="container">
        ...
        <i class="bi-check-circle-fill text-success">Hosting veloce</i><br>
        <i class="bi-check-circle-fill text-success">Semplice e automatico</i><br>
        <i class="bi-check-circle-fill text-success">Altamente personalizzabile</i><br>
