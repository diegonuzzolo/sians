...
<div class="bg-dark text-white  text-center py-5" style="height: 100vh; border-radius: 15px; background-image: url('assets/minecraft-bg3.jpg'); background-size: cover; background-position: center;">
