...
<div class="bg-dark text-white  text-center py-5" style="border-radius: 15px; background-image: url('assets/minecraft-bg2.jpg'); background-size: cover; background-position: center;">
    <div class="container">
        ...
        <span class="badge badge-success"><p style=" padding: 5px; margin: 10px; font-weight: bold; text-align: center;" class="lead fs-2">Hosting veloce </p></span>
        <span class="badge badge-success"><p style=" padding: 5px; margin: 10px; font-weight: bold; text-align: center;" class="lead fs-2">Semplice e automatico </p></span>
        <span class="badge badge-success"><p style=" padding: 5px; margin: 10px; font-weight: bold; text-align: center;" class="lead fs-2">Altamente personalizzabile </p></span>
