...
<div class="bg-dark text-white  text-center py-5" style="height: 50vh; border-radius: 15px; background-image: url('assets/banner.png'); background-size: cover; background-position: center;">
</div>
