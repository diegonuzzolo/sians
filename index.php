...
<div class="bg-dark text-white  text-center py-5" style="border-radius: 15px; background-image: url('assets/minecraft-bg2.jpg'); background-size: cover; background-position: center;">
    <div class="container">
        ...
        <span class="badge badge-success">Hosting veloce </span>
        <span class="badge badge-success">Semplice e automatico </span>
        <span class="badge badge-success">Altamente personalizzabile </span>
