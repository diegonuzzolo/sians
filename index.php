...
<div class="bg-dark text-white  text-center py-5" style="border-radius: 15px; background-image: url('assets/minecraft-bg2.jpg'); background-size: cover; background-position: center;">
    <div class="container">
        ...
        <i class="bi-check-circle-fill text-success"><p style=" padding: 5px; margin: 10px; font-weight: bold; text-align: start;" class="lead fs-2">Semplice e automatico </p>
        <i class="bi-check-circle-fill text-success"><p style=" padding: 5px; margin: 10px; font-weight: bold; text-align: start;" class="lead fs-2">Altamente personalizzabile </p>
