...
<div class="bg-dark text-white text-center py-5" style="background-image: url('assets/minecraft-bg2.jpg'); background-size: cover; background-position: center;">
    <div class="container">
        ...
        <p style="background-color: lightblue; padding: 1px; margin: 1px; font-weight: bold;" class="lead">Hosting veloce, semplice e automatico. Altamente personalizzabile.</p>
